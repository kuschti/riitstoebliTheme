	...
	?>
		...
		<div id="site-generator" class="clearfix">
			...
			<ul class="credit">
				...
				<li><?php _e('<span class="slash"> //</span> Proudly powered by', 'pohutukawa') ?> <a href="http://wordpress.org/" ><?php _e('WordPress', 'pohutukawa') ?></a></li>
				<li><?php printf( __( '<span class="slash"> //</span> Theme: %1$s by %2$s', 'pohutukawa' ), 'Pohutukawa', '<a href="http://www.elmastudio.de/wordpress-themes/">Elmastudio</a>' ); ?></li>
				<?php } ?>
			</ul>
